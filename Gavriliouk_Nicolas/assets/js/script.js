...
let Sophisme = [
...

    {
        ...
        Description:
            "You are making an argument that because something is 'natural' it is therefore valid, justified, inevitable,good, or ideal.",
...
function afficherIntro(evenement) {
    ...
    if (mouseEvent != null) {
        ...
        collisionText = verifierCollisions(nPositionCurseurX, nPositionCurseurY, 325, 225, 150, 30);
...
function tutoriel() {
    if (mouseEvent != null) {
        ...
        collisionTutoriel = verifierCollisions(nPositionCurseurX, nPositionCurseurY, 25, 25, 50, 50);
...
function clicCanvas(evenement) {
    ...
    collisionEcran = verifierCollisions(nPositionCurseurX, nPositionCurseurY, 0, 0, nLargeur, nHauteur);
    ...
    if (sEtatJeu == "intro") {
        let collision = false;
        collision = verifierCollisions(nPositionCurseurX, nPositionCurseurY, 325, 225, 150, 30);
        if (collision == true) {
            sEtatJeu = "jeu";
            PeutBouger = true;
        }
        ...
        let collisionReponse = verifierCollisions(nPositionCurseurX, nPositionCurseurY, 0, 0, nLargeur, nHauteur);
...
function afficherJeu() {
    ...
    collisionText = verifierCollisions(nPositionCurseurX, nPositionCurseurY, 150, 423, 50, 50);
    ...
    collisionText = verifierCollisions(nPositionCurseurX, nPositionCurseurY, 600, 423, 50, 50);
    // console.log(collisionText)
    if (collisionText == true) {
        //  console.log("right")
        //  oContexte.fillStyle = "red"
...
function verifierCollisions(positionXCurseur, positionYCurseur, positionXElement, positionYElement, largeurElement, hauteurElement) {
    if (
...
function BoiteDialogue(evenement) {
    ...
    //droite
    collisionDroite = verifierCollisions(nPositionCurseurX, nPositionCurseurY, 600, 425, 50, 50);
    ...
    //gauche
    collisionGauche = verifierCollisions(nPositionCurseurX, nPositionCurseurY, 150, 425, 50, 50);
    ...
    if (bActive == true && (collisionGauche == true || collisionDroite == true)) {
        sDialogues = CurrentDialogues[nIndex];
