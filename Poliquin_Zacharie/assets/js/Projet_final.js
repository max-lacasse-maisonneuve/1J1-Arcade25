...
let oPersonnageBleuTombant = {
    ...
    vitesse: 5,
    image: new Image(),
    srcConclusion: "assets/images/personnage/Dude_Monster/Dude_Monster_Death_8.png",
};
...
let oPersonnageRoseTombant = {
    ...
    vitesse: 5,
    image: new Image(),
    srcConclusion: "assets/images/personnage/Pink_Monster/Pink_Monster_Death_8.png",
};
...
function onClicCanvas(evenement) {
    ...
    if (sEtat == "Intro") {
        let PlayBouton = AppuyerBouton(PositionXCurseur, PositionYCurseur, oImgPLay.x, oImgPLay.y, oImgPLay.largeur, oImgPLay.hauteur);
        if (PlayBouton == true) {
            sEtat = "ChoixJeu";
            SonPlay.play();
        }
...
let listeImagesObjets = [
    ...
    oPersonnageRoseIntro.image, // <-- Correction ici: .image
    BallonBeige.image,
    BallonBleu.image,
    BallonRouge.image,
    BallonVert.image,
...
function afficherIntro() {
    ...
    oContexte.drawImage(oImgFondIntro.image, oImgFondIntro.x, oImgFondIntro.y, oImgFondIntro.largeur, oImgFondIntro.hauteur);
    oContexte.drawImage(
        oImgFondIntro.image,
    ...
    oContexte.fillRect(nLargeurCanvas - 93, 0, nLargeurCanvas - 186, nHauteurCanvas);

    oContexte.fillRect(0, nHauteurCanvas - 93, nLargeurCanvas, nHauteurCanvas - 186);
    ...
    for (let i = 0; i < oImgCasesIntro.length; i++) {
        ...
        oContexte.fillRect(CarreIntro.x, CarreIntro.y, CarreIntro.largeur, CarreIntro.hauteur);
    }
    ...
    oContexte.save();
    oContexte.translate(oPersonnageRoseIntro.x + oPersonnageRoseIntro.largeur / 2, oPersonnageRoseIntro.y);
    oContexte.scale(-1, 1);
    oContexte.translate(-(oPersonnageRoseIntro.x + oPersonnageRoseIntro.largeur / 2), -oPersonnageRoseIntro.y);
...
function oFondChoixJeu() {
    ...
    oContexte.drawImage(oImgFondChoixJeu.image, oImgFondChoixJeu.x, oImgFondChoixJeu.y, oImgFondChoixJeu.largeur, oImgFondChoixJeu.hauteur);
    ...
    oContexte.save();
    oContexte.translate(oChoixPersonnageRose.x + oChoixPersonnageRose.largeur / 2, oChoixPersonnageRose.y);
    oContexte.scale(-1, 1);
    oContexte.translate(-(oChoixPersonnageRose.x + oChoixPersonnageRose.largeur / 2), -oChoixPersonnageRose.y);
    if (fondtemps % 5 == 0) {
    ...
    oContexte.textAlign = "center";
    oContexte.fillText("Appuyez sur   ou             pour aller vers le      !", nLargeurCanvas / 2, 590);
    oContexte.fillText("Appuyez sur	  ou            pour aller vers le     !", nLargeurCanvas / 2, 640);
    oContexte.fillText("Appuyez sur   ou               pour aller vers la        !", nLargeurCanvas / 2, 690);
    oContexte.fillText("Appuyez sur   ou               pour aller vers la        !", nLargeurCanvas / 2, 740);

    oContexte.fillStyle = "black";
    oContexte.fillText("          W    Flèche Haut                    Haut", nLargeurCanvas / 2, 590);
    oContexte.fillText("          S    Flèche Bas                    Bas", nLargeurCanvas / 2, 640);
    oContexte.fillText("          A    Flèche Gauche                    Gauche", nLargeurCanvas / 2, 690);
    oContexte.fillText("          D    Flèche Droite                    Droite", nLargeurCanvas / 2, 740);
}

// ////////////////////////////////////////////Jeu 1

function afficherJeu1() {
    oContexte.drawImage(oImgFondJeu1.image, oImgFondJeu1.x, oImgFondJeu1.y, oImgFondJeu1.largeur, oImgFondJeu1.hauteur);
...
function JoueurChoisi() {
    ...
    if (sPersonnageChoisi == "bleu") {
        ...
        oPersonnageBleuJeu.x = Math.max(Min_x, Math.min(oPersonnageBleuJeu.x, Max_x));
        oPersonnageBleuJeu.y = Math.max(Min_y, Math.min(oPersonnageBleuJeu.y, Max_y));
    ...
    if (sPersonnageChoisi == "rose") {
        ...
        oPersonnageRoseJeu.x = Math.max(Min_x, Math.min(oPersonnageRoseJeu.x, Max_x));
        oPersonnageRoseJeu.y = Math.max(Min_y, Math.min(oPersonnageRoseJeu.y, Max_y));
...
function UI() {
    ...
    if (minuterie <= 10 && minuterie >= 7) {
        ...
        oContexte.fillStyle = "black";
        oContexte.font = "40px 'Press Start 2P'";
        oContexte.fillText(`TEMPS RESTANT : ${minuterie} s`, nLargeurCanvas / 2, nHauteurCanvas - 20);
...
function AfficherCases() {
    for (let i = 0; i < oCasesJeu.length; i++) {
        ...
        oContexte.fillRect(CarreJeu.x, CarreJeu.y, CarreJeu.largeur, CarreJeu.hauteur);
    }
}
...
function FondJeu2() {
    ...
    if (nFondJeu2Aleatoire <= 16.5) {
        oContexte.drawImage(FondBaie.image, FondBaie.x, FondBaie.y, FondBaie.largeur, FondBaie.hauteur);
    } else if (nFondJeu2Aleatoire <= 33 && nFondJeu2Aleatoire > 16.5) {
        oContexte.drawImage(FondCiel.image, FondCiel.x, FondCiel.y, FondCiel.largeur, FondCiel.hauteur);
    } else if (nFondJeu2Aleatoire <= 49.5 && nFondJeu2Aleatoire > 33) {
        oContexte.drawImage(FondVille.image, FondVille.x, FondVille.y, FondVille.largeur, FondVille.hauteur);
    } else if (nFondJeu2Aleatoire <= 66 && nFondJeu2Aleatoire > 49.5) {
        oContexte.drawImage(FondDirigeable.image, FondDirigeable.x, FondDirigeable.y, FondDirigeable.largeur, FondDirigeable.hauteur);
    } else if (nFondJeu2Aleatoire <= 82.5 && nFondJeu2Aleatoire > 66) {
        oContexte.drawImage(FondIceberg.image, FondIceberg.x, FondIceberg.y, FondIceberg.largeur, FondIceberg.hauteur);
    } else if (nFondJeu2Aleatoire <= 99 && nFondJeu2Aleatoire > 82.5) {
        oContexte.drawImage(FondCratere.image, FondCratere.x, FondCratere.y, FondCratere.largeur, FondCratere.hauteur);
    } else if (nFondJeu2Aleatoire <= 100 && nFondJeu2Aleatoire > 99) {
        oContexte.drawImage(FondPlanete.image, FondPlanete.x, FondPlanete.y, FondPlanete.largeur, FondPlanete.hauteur);

        oContexte.fillStyle = "white";
        oContexte.fillText("Tu as eu l'image secret !", nLargeurCanvas / 2, nHauteurCanvas / 2 + 250);
        oContexte.fillText("Prend une capture d'écran !", nLargeurCanvas / 2, nHauteurCanvas / 2 + 350);
    }
}
...
function Ballon() {
    ...
    for (let i = 0; i < BallonsActifs.length; i++) {
        ...
        if (ballon.image && ballon.image.complete && ballon.image.naturalWidth > 0) {
            if (ballon.tempsAvantDepart <= 0) {
                oContexte.drawImage(ballon.image, ballon.x, ballon.y, ballon.largeur, ballon.hauteur);
            }
        }
    }
}
...
function AfficherJeu2() {
    //////////////////////////////////////////////////////////////////////////////// Palier de Pierre
    oContexte.drawImage(FondPalierBallon.image, FondPalierBallon.x, FondPalierBallon.y, FondPalierBallon.largeur, FondPalierBallon.hauteur);
    ...
    oContexte.save();
    oContexte.translate(oPersonnageRoseConcluDanse.x + oPersonnageRoseConcluDanse.largeur / 2, oPersonnageRoseConcluDanse.y);
    oContexte.scale(-1, 1);
    oContexte.translate(-(oPersonnageRoseConcluDanse.x + oPersonnageRoseConcluDanse.largeur / 2), -oPersonnageRoseConcluDanse.y);
...
function afficherFinMauvais() {
    debugger;
    oContexte.drawImage(oImgFinMauvais.image, oImgFinMauvais.x, oImgFinMauvais.y, oImgFinMauvais.largeur, oImgFinMauvais.hauteur);
    ...
    if (sPersonnageChoisi == "bleu") {
        ...
        oContexte.translate(-(oPersonnageBleuTombant.x + oPersonnageBleuTombant.largeur / 2), -oPersonnageBleuTombant.y);
        ...
        oPersonnageBleuTombant.y = oPersonnageBleuTombant.y + oPersonnageBleuTombant.vitesse;
    ...
    if (sPersonnageChoisi == "rose") {
        ...
        oContexte.translate(-(oPersonnageRoseTombant.x + oPersonnageRoseTombant.largeur / 2), -oPersonnageRoseTombant.y);
        ...
        oPersonnageRoseTombant.y = oPersonnageRoseTombant.y + oPersonnageRoseTombant.vitesse;
    ...
    oContexte.font = "60px Pacifico";
    oContexte.fillStyle = "white";
    oContexte.fillText("Color Minigames", nLargeurCanvas / 2, nHauteurCanvas / 2 - 327);
    oContexte.font = "50px Pacifico";
    oContexte.fillText("Par Zacharie Poliquin", nLargeurCanvas / 2, nHauteurCanvas - 25);
    oContexte.font = "60px Pacifico";
    oContexte.fillStyle = "red";
    ...
    for (let i = 0; i < oImgCasesFin1.length; i++) {
        ...
        oContexte.fillRect(CarreFin1.x, CarreFin1.y, CarreFin1.largeur, CarreFin1.hauteur);
    }
    ...
    for (let i = 0; i < oImgCasesFin2.length; i++) {
        ...
        oContexte.fillRect(CarreFin2.x, CarreFin2.y, CarreFin2.largeur, CarreFin2.hauteur);
    }
}

function afficherFinBon() {
    oContexte.drawImage(oImgFinBonne.image, oImgFinBonne.x, oImgFinBonne.y, oImgFinBonne.largeur, oImgFinBonne.hauteur);
    ...
    oContexte.fillText("Color Minigames", nLargeurCanvas / 2, nHauteurCanvas / 2 - 327);
    oContexte.font = "50px Pacifico";
    oContexte.fillText("Par Zacharie Poliquin", nLargeurCanvas / 2, nHauteurCanvas - 30);
...
function AppuyerBouton(PositionXCurseur, PositionYCurseur, PositionXObjet, PositionYObjet, largeurObjet, hauteurObjet) {
    let DansZone = false;
