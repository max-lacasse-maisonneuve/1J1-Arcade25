...
function clicCanvas(evenement) {
  ...
  if (sEtatJeu == "choix Question") {
    for (let i = 0; i < tableauBoutonsChoixQuestion.length; i++) {
      ...
      let collision = CollisionChoixQuestion(
        PositionXCurseur,
        PositionYCurseur,
        boutonQuestionCliquee
      );
  ...
  if (sEtatJeu == "intro") {
    let boutonJouerClique = zoneDuBoutonJouer(
      PositionXCurseur,
      PositionYCurseur,
      500,
      570,
    ...
    let boutonContinuerClique = zoneDuBoutonContinuer(
      PositionXCurseur,
      PositionYCurseur,
      360,
      502,
    ...
    let petiteCarteCliquee = zoneDeLaPetiteCarte (
      PositionXCurseur,
      PositionYCurseur,
      230,
      476,
    ...
    sEtatJeu = "score"
    let boutonRejouerClique = zoneDuBoutonRejouer( 
      PositionXCurseur,
      PositionYCurseur,
      360,
      502,
...
function afficherRegle() {
  ...
  oContexte.drawImage(
    oimageTopFrame.image,
    oimageTopFrame.x,
    oimageTopFrame.y,
    oimageTopFrame.largeur,
    oimageTopFrame.hauteur
  );
  ...
  oContexte.fillText(
    "Continuer",
    nLargeurCanvas / 2 - 185,
    nHauteurCanvas / 2 + 240
  );
  oContexte.textAlign = "left"
  oContexte.font = "50px Energize"
  oContexte.fillStyle = "white"
  oContexte.fillText(
    "Règlements",
    nLargeurCanvas / 2 - 470,
    nHauteurCanvas / 2 - 230
  );
  oContexte.textAlign = "left"
  oContexte.font = "20px Bahnschrift"
  oContexte.fillStyle = "white"
  oContexte.fillText(
    "Ton but est de récolter le plus de points possible",
  ...
  oContexte.fillStyle = "white"
  oContexte.fillText(
    "Tu pourras répondre à 6 question au total",
    nLargeurCanvas / 2 - 450,
    nHauteurCanvas / 2 - 170
  );
  ...
  oContexte.fillStyle = "white"
  oContexte.fillText(
    "et tu auras 20 secondes pour répondre à chaque question.",
    nLargeurCanvas / 2 - 450,
    nHauteurCanvas / 2 - 150
  );
  oContexte.textAlign = "left"
  oContexte.font = "10px Bahnschrift"
  oContexte.fillStyle = "white"
  oContexte.fillText(
    "En plus c'est plus lent que des vraie secondes, je pense.",
    nLargeurCanvas / 2 - 450,
  ...
  oContexte.fillStyle = "white"
  oContexte.fillText(
    "qu'il te restait de temps pour répondre.",
    nLargeurCanvas / 2 - 450,
    nHauteurCanvas / 2 - 90
  );
  ...
  oContexte.fillStyle = "white"
  oContexte.fillText(
    "Mais quand tu te trompe, tu ne perds pas de points",
    nLargeurCanvas / 2 - 450,
    nHauteurCanvas / 2 - 60
  );
  ...
  oContexte.fillStyle = "white"
  oContexte.fillText(
    "et parce que j'ai pitié de vous",
    nLargeurCanvas / 2 - 450,
    nHauteurCanvas / 2 - 30
  );
...
function zoneDuBoutonContinuer(
  PositionXCurseur,
  PositionYCurseur,
  PositionXObjet,
  PositionYObjet,
...
function CarteActivee () {
  ...
  if (nTempsPasse % 60 == 0) {
    ...
    oContexte.fillText(
    " temps de la carte:" + nQuestionMinuteur,
    nLargeurCanvas / 2,
    nHauteurCanvas / 2 - 200
    );

      oContexte.drawImage (
      oimageCarteMetro.image,
      oimageCarteMetro.x,
      oimageCarteMetro.y,
      oimageCarteMetro.largeur,
      oimageCarteMetro.hauteur
    ); 

    oContexte.drawImage (
      oimageSmollCross.image,
      oimageSmollCross.x,
      oimageSmollCross.y,
      oimageSmollCross.largeur,
      oimageSmollCross.hauteur
    );
...
function afficherChoixQuestion() {
  ...
  oContexte.fillStyle = "white";
  oContexte.fillText(
    " temps restant:" + nQuestionMinuteur,
    nLargeurCanvas / 2 + 275,
    80
  );
  ...
  oContexte.fillStyle = "white";
  oContexte.fillText(
    " points obtenu:" + nPoints,
    nLargeurCanvas / 2 - 290,
    80
  );
  ...
  oContexte.fillStyle = "white";
  oContexte.fillText(
    " Question" + nQuestionRepondue + "/6",
    nLargeurCanvas / 2 + 320,
    580
  );
  oContexte.font = "30px Energize"
...
function AfficherQuestion() {
  if (nQuestionPosee == 1) {
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "Quel Station est la plus proche",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 195,
    );
    oContexte.textAlign = "center";
    oContexte.font = "50px Energize";
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "du chalet du Mont royal?",
      nLargeurCanvas / 2,
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "Quel est la station la plus proche de",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 195
    );
       oContexte.textAlign = "center";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "Laquelle de ces stations n'est pas",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 195
    ); 
    oContexte.textAlign = "center";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "Laquelle de ces stations ne connecte",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 195
    );
    oContexte.textAlign = "center";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "Pour aller de la station McGil là la station Cardillac",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 195
    );
    oContexte.textAlign = "center";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "Dans quels directions doit on aller?",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 165
    );
    oContexte.textAlign = "center";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "Quels directions doit ont prendre pour",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 195
    );
     oContexte.textAlign = "center";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "aller de la station Plamondon à la station Verdun?",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 165
    );
    oContexte.textAlign = "center";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "Quels directions prendre pour aller de la",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 195
    );
     oContexte.textAlign = "center";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "station Charlevoix à la station Édouard-Monpetit rapidement?",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 165
    );
    oContexte.textAlign = "center";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "Quel directions prendre pour aller de la",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 195
    );
    console.log ("Question 15")
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "station Parc à la station Pie-IX rapidement",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 165
    );
    oContexte.textAlign = "center";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "station Viau à la station Vendôme",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 165,
    );
    oContexte.textAlign = "center";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "Station Jarry à la station Jean Drapeau?",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 165
    );
    oContexte.textAlign = "center";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "Comment savoir si un autobus a une",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 195
    );
      console.log ("Question 20")
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "rampe d'accès pour chaise roulante?",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 165
    );
    oContexte.textAlign = "center";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "À partir de quel âge les frais",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 195
    );
    oContexte.textAlign = "center";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "d'émission de la carte OPUS s'apliquent",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 165
    );
    oContexte.textAlign = "center";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
      "n'a pas de rabais sur leur carte OPUS?",
      nLargeurCanvas / 2,
      nHauteurCanvas / 2 - 165
    );
    oContexte.textAlign = "center";
...
function AfficherScore () {
  ...
  oContexte.drawImage(
   ...
   oContexte.textAlign = "left";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
    "Tu as remporté " + nPoints + " points",
    nLargeurCanvas / 2 - 325,
    nHauteurCanvas / 2 + 120
  );
  ...
  oContexte.textAlign = "left";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
    "Donc tu es une personne normale",
    nLargeurCanvas / 2 - 325,
    nHauteurCanvas / 2 + 140
  );
  oContexte.textAlign = "left";
  ...
  oContexte.textAlign = "left";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
    " Ok, j'ai pas de message interessant ici, t'es juste bon.",
    nLargeurCanvas / 2 - 325,
    nHauteurCanvas / 2 + 140
  );
  oContexte.textAlign = "left";
  ...
  oContexte.textAlign = "left";
    ...
    oContexte.fillStyle = "white";
    oContexte.fillText(
    " T'en connais surprenamment, est ce que ça va?",
    nLargeurCanvas / 2 - 325,
    nHauteurCanvas / 2 + 140
  );
  oContexte.textAlign = "left";
