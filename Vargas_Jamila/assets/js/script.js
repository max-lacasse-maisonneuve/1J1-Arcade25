...
function DessinerNuage() {
    ...
    /*nuage1*/
    oContexte.drawImage(oNuage1.image, oNuage1.x, -170, oNuage1.largeur, oNuage1.hauteur);
    /*texte*/
    oContexte.drawImage(oTexteBubble1.image, -250, -200, oTexteBubble1.largeur * 1.5, oTexteBubble1.hauteur * 1.5);
    /*style*/
    ...
    oContexte.drawImage(oNuage2.image, oNuage2.x, -35, oNuage2.largeur, oNuage2.hauteur);
}
...
function DessinerJeuPorte() {
    /*fond*/
    oContexte.drawImage(oFondPorte.image, oFondPorte.x, oFondPorte.y, nLargeurCanvas, nHauteurCanvas);
    /*personnage*/
    oContexte.drawImage(oChevalier.image, 240, 400, oChevalier.largeur * 4, oChevalier.hauteur * 4);
    /*portes*/
    oContexte.drawImage(oPortefermer_1.image, -15, -110, oPortefermer_1.largeur, oPortefermer_1.hauteur * 1.5);
    oContexte.drawImage(oPortefermer_2.image, -380, -110, oPortefermer_2.largeur, oPortefermer_2.hauteur * 1.5);
    oContexte.drawImage(oPortefermer_3.image, 360, -110, oPortefermer_3.largeur, oPortefermer_3.hauteur * 1.5);
    /*question*/
    oContexte.drawImage(oTexteBubble1.image, -250, -200, oTexteBubble1.largeur * 1.5, oTexteBubble1.hauteur * 1.5);
    /*bulle reponse*/
    oContexte.drawImage(oTexteBubble2.image, -115, 200, oTexteBubble2.largeur * 0.5, oTexteBubble2.hauteur * 0.5);
    oContexte.drawImage(oTexteBubble2.image, 255, 200, oTexteBubble2.largeur * 0.5, oTexteBubble2.hauteur * 0.5);
    oContexte.drawImage(oTexteBubble2.image, 630, 200, oTexteBubble2.largeur * 0.5, oTexteBubble2.hauteur * 0.5);
    /*coeur*/
...
function MonstreChiffrePorte() {
    ...
    if (NbPorte1 == 1) {
        oContexte.drawImage(Mchiffre_un.image, 70, 400, Mchiffre_un.largeur * 2, Mchiffre_un.hauteur * 2);
    } else if (NbPorte1 == 2) {
        oContexte.drawImage(Mchiffre_deux.image, 70, 400, Mchiffre_deux.largeur * 2, Mchiffre_deux.hauteur * 2);
    } else if (NbPorte1 == 3) {
        oContexte.drawImage(Mchiffre_trois.image, 70, 400, Mchiffre_trois.largeur * 2, Mchiffre_trois.hauteur * 2);
    } else if (NbPorte1 == 4) {
        oContexte.drawImage(Mchiffre_quatre.image, 70, 400, Mchiffre_quatre.largeur * 2, Mchiffre_quatre.hauteur * 2);
    } else if (NbPorte1 == 5) {
        oContexte.drawImage(Mchiffre_cinq.image, 70, 400, Mchiffre_cinq.largeur * 2, Mchiffre_cinq.hauteur * 2);
    } else if (NbPorte1 == 6) {
        oContexte.drawImage(Mchiffre_six.image, 70, 400, Mchiffre_six.largeur * 2, Mchiffre_six.hauteur * 2);
    } else if (NbPorte1 == 7) {
        oContexte.drawImage(Mchiffre_sept.image, 70, 400, Mchiffre_sept.largeur * 2, Mchiffre_sept.hauteur * 2);
    } else if (NbPorte1 == 8) {
        oContexte.drawImage(Mchiffre_huit.image, 70, 400, Mchiffre_huit.largeur * 2, Mchiffre_huit.hauteur * 2);
    } else if (NbPorte1 == 9) {
        oContexte.drawImage(Mchiffre_neuf.image, 70, 400, Mchiffre_neuf.largeur * 2, Mchiffre_neuf.hauteur * 2);
    }

    /*Pour le nombre de droite*/
    if (NbPorte2 == 1) {
        oContexte.drawImage(Mchiffre_un.image, 570, 400, Mchiffre_un.largeur * 2, Mchiffre_un.hauteur * 2);
    } else if (NbPorte2 == 2) {
        oContexte.drawImage(Mchiffre_deux.image, 570, 400, Mchiffre_deux.largeur * 2, Mchiffre_deux.hauteur * 2);
    } else if (NbPorte2 == 3) {
        oContexte.drawImage(Mchiffre_trois.image, 570, 400, Mchiffre_trois.largeur * 2, Mchiffre_trois.hauteur * 2);
    } else if (NbPorte2 == 4) {
        oContexte.drawImage(Mchiffre_quatre.image, 570, 400, Mchiffre_quatre.largeur * 2, Mchiffre_quatre.hauteur * 2);
    } else if (NbPorte2 == 5) {
        oContexte.drawImage(Mchiffre_cinq.image, 570, 400, Mchiffre_cinq.largeur * 2, Mchiffre_cinq.hauteur * 2);
    } else if (NbPorte2 == 6) {
        oContexte.drawImage(Mchiffre_six.image, 570, 400, Mchiffre_six.largeur * 2, Mchiffre_six.hauteur * 2);
    } else if (NbPorte2 == 7) {
        oContexte.drawImage(Mchiffre_sept.image, 570, 400, Mchiffre_sept.largeur * 2, Mchiffre_sept.hauteur * 2);
    } else if (NbPorte2 == 8) {
        oContexte.drawImage(Mchiffre_huit.image, 570, 400, Mchiffre_huit.largeur * 2, Mchiffre_huit.hauteur * 2);
    } else if (NbPorte2 == 9) {
        oContexte.drawImage(Mchiffre_neuf.image, 570, 400, Mchiffre_neuf.largeur * 2, Mchiffre_neuf.hauteur * 2);
    }
}
//========= FUNCTION JEUBOSS
...
function DessinerJeuBoss() {
    /*fond*/
    oContexte.drawImage(oFondBoss.image, oFondBoss.x, oFondBoss.y, nLargeurCanvas, nHauteurCanvas);
    /*personnage*/
    oContexte.drawImage(oChevalier.image, 50, 300, oChevalier.largeur * 4, oChevalier.hauteur * 4);
    oChevalier.image.src = oChevalier.src;
    oContexte.drawImage(oDragon.image, 300, -160, oDragon.largeur * 8, oDragon.hauteur * 8);
    /*question*/
    oContexte.drawImage(oTexteBubble1.image, -250, -200, oTexteBubble1.largeur * 1.5, oTexteBubble1.hauteur * 1.5);
    /*bulle reponse*/
    oContexte.drawImage(oTexteBubble2.image, -115, 200, oTexteBubble2.largeur * 0.5, oTexteBubble2.hauteur * 0.5);
...
function MonstreChiffreBoss() {
    /*Pour le nombre de gauche*/
    if (NbBoss1 == 5) {
        oContexte.drawImage(Mchiffre_cinq.image, 10, 530, Mchiffre_cinq.largeur * 1.5, Mchiffre_cinq.hauteur * 1.5);
    } else if (NbBoss1 == 6) {
        oContexte.drawImage(Mchiffre_six.image, 10, 530, Mchiffre_six.largeur * 1.5, Mchiffre_six.hauteur * 1.5);
    } else if (NbBoss1 == 7) {
        oContexte.drawImage(Mchiffre_sept.image, 10, 530, Mchiffre_sept.largeur * 1.5, Mchiffre_sept.hauteur * 1.5);
    } else if (NbBoss1 == 8) {
        oContexte.drawImage(Mchiffre_huit.image, 10, 530, Mchiffre_huit.largeur * 1.5, Mchiffre_huit.hauteur * 1.5);
    } else if (NbBoss1 == 9) {
        oContexte.drawImage(Mchiffre_neuf.image, 10, 530, Mchiffre_neuf.largeur * 1.5, Mchiffre_neuf.hauteur * 1.5);
    }

    /*Pour le nombre de droite*/
    if (NbBoss2 == 5) {
        oContexte.drawImage(Mchiffre_cinq.image, 750, 530, Mchiffre_cinq.largeur * 1.5, Mchiffre_cinq.hauteur * 1.5);
    } else if (NbBoss2 == 6) {
        oContexte.drawImage(Mchiffre_six.image, 750, 530, Mchiffre_six.largeur * 1.5, Mchiffre_six.hauteur * 1.5);
    } else if (NbBoss2 == 7) {
        oContexte.drawImage(Mchiffre_sept.image, 750, 530, Mchiffre_sept.largeur * 1.5, Mchiffre_sept.hauteur * 1.5);
    } else if (NbBoss2 == 8) {
        oContexte.drawImage(Mchiffre_huit.image, 750, 530, Mchiffre_huit.largeur * 1.5, Mchiffre_huit.hauteur * 1.5);
    } else if (NbBoss2 == 9) {
        oContexte.drawImage(Mchiffre_neuf.image, 750, 530, Mchiffre_neuf.largeur * 1.5, Mchiffre_neuf.hauteur * 1.5);
    }
}
...
function DessinerBravo() {
    /*fond*/
    oContexte.drawImage(oFondBravo.image, oFondBravo.x, oFondBravo.y, nLargeurCanvas, nHauteurCanvas);
    /*personnage*/
    oContexte.drawImage(oChevalier.image, 170, 380, oChevalier.largeur * 4, oChevalier.hauteur * 4);
    oContexte.drawImage(oPrincesse.image, 310, 370, oPrincesse.largeur * 4, oPrincesse.hauteur * 4);
    /*texte et style*/
    oContexte.drawImage(oTexteBubble3.image, -250, -200, oTexteBubble3.largeur * 1.5, oTexteBubble3.hauteur * 1.5);
    oContexte.fillStyle = "black";
...
function Ballon() {
    ...
    oContexte.drawImage(oBallon_1.image, oBallon_1.x, oBallon_1.y, oBallon_1.largeur, oBallon_1.hauteur);
    oBallon_2.y -= oBallon_2.vitesse;
    if (oBallon_2.y < -350) {
        oBallon_2.y = 700;
        oBallon_2.x = Math.random() * (nHauteurCanvas - oBallon_2.hauteur);
    }
    oContexte.drawImage(oBallon_2.image, oBallon_2.x, oBallon_2.y, oBallon_2.largeur, oBallon_2.hauteur);
}
...
function DessinerDefaite() {
    ...
    oContexte.drawImage(oFondBoss.image, oFondBoss.x, oFondBoss.y, nLargeurCanvas, nHauteurCanvas);
    /*personnage*/
    oContexte.drawImage(oChevalier.image, 260, 310, oChevalier.largeur * 4, oChevalier.hauteur * 4);
    /*Monstre*/
    oContexte.drawImage(oMonstre3.image, 20, 330, oMonstre3.largeur * 3, oMonstre3.hauteur * 3);
    oContexte.drawImage(oMonstre3.image, 400, 510, oMonstre3.largeur * 3, oMonstre3.hauteur * 3);
    oContexte.drawImage(oMonstre2.image, 450, 320, oMonstre2.largeur * 3, oMonstre2.hauteur * 3);
    oContexte.drawImage(oMonstre2.image, -150, 420, oMonstre2.largeur * 3, oMonstre2.hauteur * 3);
    oContexte.drawImage(oMonstre1.image, 100, 450, oMonstre1.largeur * 3, oMonstre1.hauteur * 3);
    oContexte.drawImage(oMonstre1.image, 640, 420, oMonstre1.largeur * 3, oMonstre1.hauteur * 3);
    /*texte et style*/
    oContexte.drawImage(oTexteBubble3.image, -250, -200, oTexteBubble3.largeur * 1.5, oTexteBubble3.hauteur * 1.5);
    oContexte.fillStyle = "black";
    oContexte.font = "60px fette";
...
function detecterClicObjet(curseurX, curseurY, zone) {
    if (curseurX >= zone.x && curseurX <= zone.x + zone.largeur && curseurY >= zone.y && curseurY <= zone.y + zone.hauteur) {
        return true;
    }
    return false;
}
